...
HPKI 電子署名ツールの導入・運用を担当される**IT 担当者・技術責任者の方**向けの技術仕様書です。

専門用語をそのまま使用しています。

## UI のスクリーンショット

| デスクトップ | モバイル幅（タブレット相当） |
|-------------|-----------------------------|
| ![デスクトップ](../../screenshots/05-main-ui.png) | ![モバイル](../../screenshots/50-mobile-main-ui.png) |

レスポンシブ対応。最低横幅 360px 程度から動作。
...
- [05_compliance.md](05_compliance.md): 3省2ガイドライン・e-文書法・電子署名法対応
