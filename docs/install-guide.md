...
初回起動時のみ、ベータ版利用にあたっての同意ダイアログが表示されます：

![ベータ版同意ダイアログ](screenshots/01-beta-consent-dialog.png)

「同意して利用を開始」を押すと、セットアップウィザードのトップ画面に進みます：
...
- 2026-05-20 v1.1.7 対応（SHA256 検証付き自動更新・スクリーンショット追加）
- 2026-05-23 v1.1.8 対応（UIデザイン刷新：グラデーション撤去・ネイビー単色化）
